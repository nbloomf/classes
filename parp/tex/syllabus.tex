...
\begin{itemize*}
\item[(40\%)] \textbf{Quizzes:} Each lecture is followed by an online quiz; the best of three attempts is recorded.
\item[(60\%)] \textbf{Homework:} There are three programming assignments and one final project.
\end{itemize*}
