...
These 16 axioms uniquely characterize the ``integers'' we know and love; any other true statement about $\mathbb{Z}$ can be derived from them. For example: \pause
